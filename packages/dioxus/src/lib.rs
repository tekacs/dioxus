...
pub mod prelude {
    ...
    pub use dioxus_core::{
        ...
        SuspenseBoundary, SuspenseContext, VNode, VirtualDom, consume_context, current_scope_key,
        current_scope_name, provide_context, spawn, suspend, try_consume_context, use_drop,
        use_hook,
    };
